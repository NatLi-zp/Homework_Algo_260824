package de.telran.lesson_4_100924;
...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        System.out.println("Index (Iteration) = " + binarySearchIteration(array, key, 0, array.length - 1));

        System.out.printf("Index (Recurs) = %d%n", binarySearchRecurs(array, key, 0, array.length - 1));

    }

    private static int binarySearchIteration(int[] sortedArray, int valueToFind, int low, int high) {
        int index = -1;
        while (low <= high) {
